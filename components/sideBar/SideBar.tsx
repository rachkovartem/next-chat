...
export const SideBar = ({ locale }: { locale: string }) => {
  ...
  return (
    ...
    >
      <Drawer variant="permanent" className={classes.sideBarDrawer} open>
        <List className={classes.sideBarList}>
          <ListItem
            button
            className={classes.sideBarListItem}
            onClick={() =>
              router.push(`/profile/${localStorage.getItem("id")}`)
            }
          >
          ...
          <ListItem
            ...
            className={classes.sideBarListItem}
            onClick={() =>
              router.push(`/friends/${localStorage.getItem("id")}`)
            }
          >
          ...
          >
            <LanguageIcon />
            <div>{routerOptionLocale.toUpperCase()}</div>
          </ListItem>
          <ListItem
            button
